...
public class FridgeSystem : MonoBehaviour, ITrigger, IInteractable
{
    ...
    #region FIELDS
        ...
        [Space(20)] [Header("VARIABLES")]
            ...
            public WindowManager windowScript;
    ...
    #region LIFE CYCLE METHODS
        ...
        {
            /*
            if((Input.GetKeyDown(KeyCode.E) || (FindObjectOfType<PlayerShooting>().mobileShooting)) && (canInteract))
            {
                FindObjectOfType<PlayerShooting>().mobileShooting = false;
                
                canInteract = false;
                interactionScript.DisableIcon();
                windowScript.OpenWindow(true);
            }
            */
        }
