...
public class LightManipulation : MonoBehaviour
{
    ...
    #region LIFE CYCLE METHODS
        ...
        void Awake()
        {
            MyGame.Utils.AddComponent<Light2D>(out lightSource, gameObject, this.GetType().Name);   
        }
        ...
        void Update()
        {
            ...
            if(randomValue <= chanceOff) lightSource.enabled = false;
