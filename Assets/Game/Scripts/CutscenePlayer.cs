...
public class CutscenePlayer : MonoBehaviour
{
    ...
    #region CUSTOM METHODS
        ...
        void PlayCutscene()
        {
            ...
            if(!isPlayerMovable) StartCoroutine(CutsceneConstraint());
        }

        /// <summary>
        /// An example coroutine that waits for 2 seconds.
        /// </summary>
        IEnumerator CutsceneConstraint()
        {
            GameManager.instance.isInCutscene = true;

            yield return new WaitForSeconds((float)cutsceneToPlay.playableAsset.duration);
